...
<head>
    ...
    <script async="" src="{{ asset('gtag/js?id=UA-156446909-1') }}"></script>
    <script>
...
<body>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <p class="text-body-secondary mb-0">
                                ...
                                elit. Vestibulum magna nisi, ultrices ut pharetra eget.
                            </p>
                            ...
                            <div class="dropzone dropzone-multiple" data-dropzone='{"url": "https://"}'>
                                ...
                                <div class="fallback">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="file" id="customFileUpload"
                                            multiple="">
                                    </div>
                                </div>
    ...
    <!-- OFFCANVAS -->
    <!-- Offcanvas: Demo the customization -->
    <form class="offcanvas offcanvas-end" id="offcanvasDemo" tabindex="-1">
        <div class="offcanvas-body">
            ...
            <div class="btn-group-toggle row gx-2 mb-4">
                <div class="col">
                    <input class="btn-check" name="colorScheme" id="colorSchemeLight" type="radio"
                        value="light">
            ...
            <div class="btn-group-toggle row gx-2 mb-4">
                <div class="col">
                    <input class="btn-check" name="navPosition" id="navPositionSidenav" type="radio"
                        value="sidenav">
                ...
                <div class="col">
                    <input class="btn-check" name="navPosition" id="navPositionTopnav" type="radio"
                        value="topnav">
                ...
                <div class="col">
                    <input class="btn-check" name="navPosition" id="navPositionCombo" type="radio"
                        value="combo">
            ...
            <div id="sidebarSizeContainer">
                ...
                <div class="btn-group-toggle row gx-2 mb-4">
                    <div class="col">
                        <input class="btn-check" name="sidebarSize" id="sidebarSizeBase" type="radio"
                            value="base">
                    ...
                    <div class="col">
                        <input class="btn-check" name="sidebarSize" id="sidebarSizeSmall" type="radio"
                            value="small">
    ...
    <div class="offcanvas offcanvas-start" id="sidebarOffcanvasActivity" tabindex="-1">
        <div class="offcanvas-header">
            ...
            <ul class="nav nav-tabs nav-tabs-sm modal-header-tabs">
                <li class="nav-item">
                    <a class="nav-link active" data-bs-toggle="tab" href="#modalActivityAction">Reminders &
                        Others</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="tab" href="#modalActivityUser">Invites</a>
                </li>
            </ul>
        ...
        <div class="offcanvas-body">
            <div class="tab-content">
                <div class="tab-pane fade show active" id="modalActivityAction">
                    ...
                    <!-- List group -->
                    @foreach (Auth::user()->invitations as $invite)
                        <div class="list-group list-group-flush list-group-activity my-n3">
                            <div class="list-group-item text-reset">
                                <div class="row">
                                    <div class="col-auto">
                                        <!-- Avatar -->
                                        <div class="avatar avatar-sm">
                                    ...
                                    <div class="col ms-n2">
                                        <!-- Heading -->
                                        <h5 class="mb-1">
                                            You have a new invite for
                                            {{ optional($invite)->name ?? 'Unknown Contribution' }}.
                                        </h5>

                                        <!-- Action Buttons -->
                                        <div class="small mb-0 d-flex flex-row">
                                            @if ($invite->pivot->status == 0)
                                                <form method="POST" action="{{ route('invite.decision', ['decision' => 'accept', 'invite' => $invite->pivot->id]) }}" id="accept-form">
                                                    @csrf
                                                    <button type="button" class="btn btn-sm btn-success me-2" onclick="confirmSubmission('accept-form', 'Are you sure you want to accept this invite?')">Accept</button>
                                                </form>
                                                
                                                <form method="POST" action="{{ route('invite.decision', ['decision' => 'decline', 'invite' => $invite->pivot->id]) }}" id="decline-form">
                                                    @csrf
                                                    <button type="button" class="btn btn-sm btn-danger me-2" onclick="confirmSubmission('decline-form', 'Are you sure you want to decline this invite?')">Decline</button>
                                                </form>
                                        ...
                                        <!-- Time -->
                                        <small class="text-body-secondary">
                                            {{ $invite->pivot->created_at->diffForHumans() }}
                                        </small>
                                    </div>
                                </div> <!-- / .row -->
                            </div>
            ...
            mx-auto" alt="...">
                ...
                <div class="collapse navbar-collapse" id="sidebarSmallCollapse">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropend">
                            <a class="nav-link dropdown-toggle" id="sidebarSmallAuth" href="#"
                                data-bs-toggle="dropdown" data-bs-auto-close="outside" role="button"
                                aria-haspopup="true" aria-expanded="false">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="sidebarSmallAuth">
                                ...
                                <li class="dropend">
                                    <a class="dropdown-item dropdown-toggle" href="#"
                                        id="sidebarSmallPassword" role="button" data-bs-toggle="dropdown"
                                        aria-haspopup="true" aria-expanded="false">
                                        Password reset
                                    </a>
                    ...
                    <ul class="navbar-nav mb-md-4">
                        <li class="nav-item dropend">
                            <a class="nav-link dropdown-toggle " id="sidebarSmallBasics" href="#"
                                ...
                                aria-expanded="false" title="Basics">
                    ...
                    <div class="navbar-user d-none d-md-flex flex-column" id="sidebarSmallUser">
                        ...
                        <!-- Icon -->
                        <a class="navbar-user-link mb-3" data-bs-toggle="offcanvas"
            ...
            <div class="container-fluid">
                ...
                <form class="form-inline me-4 d-none d-md-flex">
                    <div class="input-group input-group-flush input-group-merge input-group-reverse"
                        ...
                        <!-- Input -->
                        <input type="search" class="form-control dropdown-toggle list-search"
                                    ...
                                    <a class="list-group-item" href="team-overview.html">
                                        <div class="row align-items-center">
                                            <div class="col-auto">
                                                ...
                                                <!-- Avatar -->
                                                <div class="avatar">
                                                    <img src="assets/img/avatars/teams/team-logo-1.jpg"
                                    ...
                                    <a class="list-group-item" href="project-overview.html">
                                        <div class="row align-items-center">
                                            <div class="col-auto">
                                                ...
                                                <!-- Avatar -->
                                                <div class="avatar avatar-4by3">
                                                    <img src="assets/img/avatars/projects/project-1.jpg"
                                                        alt="..." class="avatar-img rounded">
                                                </div>
                                    ...
                                    <a class="list-group-item" href="project-overview.html">
                                        <div class="row align-items-center">
                                            <div class="col-auto">
                                                ...
                                                <!-- Avatar -->
                                                <div class="avatar avatar-4by3">
                                                    <img src="assets/img/avatars/projects/project-2.jpg"
                                                        alt="..." class="avatar-img rounded">
                                                </div>
                                    ...
                                    <a class="list-group-item" href="project-overview.html">
                                        <div class="row align-items-center">
                                            <div class="col-auto">
                                                ...
                                                <!-- Avatar -->
                                                <div class="avatar avatar-4by3">
                                                    <img src="assets/img/avatars/projects/project-3.jpg"
                                                        alt="..." class="avatar-img rounded">
                                                </div>
